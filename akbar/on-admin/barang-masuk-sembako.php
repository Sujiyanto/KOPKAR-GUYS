...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <a href="tambah-barang-sembako.php"><button class="btn btn-primary"><span>Tambah Barang</span></button></a><br><br>
    <table id="ngoding" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 13px">
            ...
            <tr>
                    ...
                    <td>
                        ...
                        <a href="hapus-barang-masuk.php" onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-warning" id="id_barang"><span class="glyphicon glyphicon-trash"></span>Hapus</button></a>
                    </td>
            </tr>
            <?php
            }
