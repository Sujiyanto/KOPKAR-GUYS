...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <a href="tambah-barang-elektronik.php"><button class="btn btn-primary"><span>Tambah Barang</span></button></a><br><br>
    <table id="ngoding" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 13px">
            ...
            <?php
                include 'koneksi.php';
                $sql = mysqli_query($conn, "SELECT * from barang_elektronik");
            ...
            <tr>
                    ...
                    <td>
                        <a href=""><button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span>Edit</button></a>
                        <a href="hapus-barang-masuk-elektronik.php" onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-warning" id="id_barang"><span class="glyphicon glyphicon-trash"></span>Hapus</button></a>
                    </td>
            </tr>
            <?php
            }
