...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            <li>
              <a href="barang-masuk.php"><i class="fa  fa-plus"></i>
            <span class="nav-link-text">Barang Masuk</span></a>
            </li>
            <li>
              <a href="barang-keluar.php"><i class="fa  fa-minus"></i>
            <span class="nav-link-text">Barang Keluar</span></a>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <!-- Contain -->
    <form class="form-horizontal" action="aksi-tambah-supplier.php" method="post">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" name="no_telp" placeholder="No. Telp/Hp">
                  </div>
                </div>
                <div class="form-group">
