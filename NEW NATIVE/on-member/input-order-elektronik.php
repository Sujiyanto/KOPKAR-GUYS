                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                   <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-order-elektronik.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                              ...
                              <div class="form-group">
                                  <label class="col-sm-2 col-sm-2 control-label">Nama Barang</label>
                                   <div class="col-sm-8">
                                       <?php  
                                        $hasil = mysqli_query($con,"select * from barang_elektronik");
