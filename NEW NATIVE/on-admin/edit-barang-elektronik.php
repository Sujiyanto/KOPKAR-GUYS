...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                    <div class="panel">
                    <?php
                    $query = mysqli_query($con,"SELECT * FROM barang_elektronik WHERE id_barang='$_GET[kd]'");
                    $data  = mysqli_fetch_array($query);
                    ?>
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-barang-elektronik.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
