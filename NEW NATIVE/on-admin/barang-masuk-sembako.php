...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="text-left" style="margin-top: 10px;">
        <a href="input-barang-sembako.php" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle "></i> Add Barang</a>
    </div> <br>
                ...
                <br>
                  ...
                  <thead>
                    ...
                    <td>
                        <center>
                            <div id="thanks">
                                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Barang Sembako" href="edit-barang-sembako.php?hal=edit&kd=<?php echo $data['id_barang'];?>">
                                <span class="fa fa-edit"></span>
                                </a>
                                <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_barang'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Barang" href="hapus-barang-sembako.php?hal=hapus&kd=<?php echo $data['id_barang'];?>"><span class="fa fa-trash-o">
                                </a>
                        </center>
                    </td>
                    </tr>
