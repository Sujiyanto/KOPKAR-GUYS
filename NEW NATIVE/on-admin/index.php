  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                    ...
                    <div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="mr-5">
                        <?php $tampil=mysqli_query($con,"select * from member order by id_member desc");
                        ...
                        <div class="mr-5">
                        <?php $tampil=mysqli_query($con,"select * from barang_elektronik order by id_barang desc");
                              $total=mysqli_num_rows($tampil);
                        ?>
                        <span><?php echo "$total"; ?></span>
                        Barang Elektronik
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="barang-masuk-elektronik.php">
                        <span class="float-left">See More</span>
                        <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                        </span>
                        ...
                        <div class="mr-5">
                        <?php $tampil=mysqli_query($con,"select * from barang_sembako order by id_barang desc");
                              $total=mysqli_num_rows($tampil);
                        ?>
                        <span><?php echo "$total"; ?></span>
                        Barang Sembako
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="barang-masuk-sembako.php">
                        <span class="float-left">See More</span>
                        <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                        </span>
                        ...
                        <div class="mr-5">
                        <?php $tampil=mysqli_query($con,"select * from penjualan order by id_order desc");
                              $total=mysqli_num_rows($tampil);
                        ?>
                        <span><?php echo "$total"; ?></span>
                        ...
                        <a class="card-footer text-white clearfix small z-1" href="order-barang.php">
                        <span class="float-left">See More</span>
                        <span class="float-right">
                        <i class="fa fa-angle-right"></i>
                        </span>
