...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                    <div class="panel">
                    <?php
                    $query = mysqli_query($con,"SELECT * FROM supplier WHERE id_supplier='$_GET[kd]'");
                    $data  = mysqli_fetch_array($query);
                    ?>
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-supplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">ID Supplier</label>
                              <div class="col-sm-8">
                                  <input name="id_supplier" type="text" id="id_supplier" class="form-control" placeholder="Tidak perlu di isi" autofocus="on" readonly="readonly" />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama</label>
                              <div class="col-sm-8">
                                  <input name="nama" type="text" id="nama" class="form-control" placeholder="Nama" value="<?php echo $data['nama_supplier']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No. Telp</label>
                              <div class="col-sm-8">
                                  <input name="no_telp" class="form-control" id="no_telp" type="text" placeholder="No. Telp" value="<?php echo $data['no_telp']; ?>" required />
                              </div>
                          </div>
                          <div class="form-group">
