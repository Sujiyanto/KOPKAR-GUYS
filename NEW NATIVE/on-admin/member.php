...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="text-left" style="margin-top: 10px;">
        <a href="input-member.php" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle "></i> Add Member</a>
    </div> <br>
            
            <form action="member.php" method="POST">
              <div class="input-group">
              <input type='text' class="form-control input-sm pull-left" name='qcari' placeholder='Cari berdasarkan NIK' required /> 
                ...
                <br>
                  ...
                  <thead>
                    ...
                    <td>
                        <center>
                            <div id="thanks">
                                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Member" href="edit-member.php?hal=edit&kd=<?php echo $data['id_member'];?>">
                                <span class="fa fa-edit"></span>
                                </a>
                                <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_member'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Member" href="hapus-member.php?hal=hapus&kd=<?php echo $data['id_member'];?>"><span class="fa fa-trash-o">
                                </a>
                            </div>
                        </center>
                    </td>
              ...
              ?>
                  ...
                  <?php $tampil=mysqli_query($con,"select * from member order by id_member");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h6>Jumlah Member : <?php echo "$user"; ?> Orang </h6> </center>
              <!-- row end -->
                </section>
    <!-- End Contain -->
