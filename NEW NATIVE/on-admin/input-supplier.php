    ...
    <section class="content">
                            <div class="panel">
                                <div class="panel-body">
                                   <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-supplier.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input name="no_telp" class="form-control" id="no_telp" type="text" placeholder="No. Telp" required />
                                  </div>
                              </div>
                              <div class="form-group">
