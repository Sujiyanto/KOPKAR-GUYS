                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                   <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-barang-elektronik.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input name="nama_barang" type="text" id="nama_barang" class="form-control" placeholder="Nama Barang" required />
                                  </div>
                              </div>
                              <!-- <div class="form-group">
                                  <label class="col-sm-2 col-sm-2 control-label">Supplier</label>
                                  <div class="col-sm-8">
                                      <input name="supplier" type="text" id="supplier" class="form-control" placeholder="Supplier" required />
                                  </div>
                              </div> -->
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Supplier</label>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input name="uang_muka" class="form-control" id="uang_muka" type="text" placeholder="Uang Muka" required />
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-sm-2 col-sm-2 control-label">Stok</label>
                                  <div class="col-sm-8">
                                      <input name="stok" class="form-control" id="stok" type="text" placeholder="Stok" required />
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-sm-2 col-sm-2 control-label">Satuan</label>
                                  <div class="col-sm-8">
                                      <input name="satuan" class="form-control" id="satuan" type="text" placeholder="Satuan" required />
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="col-sm-2 col-sm-2 control-label">Keterangan</label>
                                  <div class="col-sm-8">
                                      <input name="keterangan" class="form-control" id="keterangan" type="text" placeholder="Keterangan" required />
                                  </div>
                              </div>
