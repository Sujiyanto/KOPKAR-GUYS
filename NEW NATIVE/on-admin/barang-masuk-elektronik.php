...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="text-left" style="margin-top: 10px;">
        <a href="input-barang-elektronik.php" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle "></i> Add Barang</a>
    </div> <br>
            
            <form action="barang-masuk-elektronik.php" method="POST">
              <div class="input-group">
              ...
              <button class="btn btn-sm btn-default" type="submit"><i class="fa fa-search"></i></button>
                ...
                <br>
                  <?php
                  $query1="select * from barang_elektronik";
                  ...
                  <thead>
                    ...
                    <td>
                        <center>
                            <div id="thanks">
                                <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Barang Elektronik" href="edit-barang-elektronik.php?hal=edit&kd=<?php echo $data['id_barang'];?>">
                                <span class="fa fa-edit"></span>
                                </a>
                                <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_barang'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Barang" href="hapus-barang-elektronik.php?hal=hapus&kd=<?php echo $data['id_barang'];?>"><span class="fa fa-trash-o">
                                </a>
                        </center>
                    </td>
                    </tr>
              ...
              ?>
                  ...
                  <?php $tampil=mysqli_query($con,"select * from barang_elektronik order by id_barang");
