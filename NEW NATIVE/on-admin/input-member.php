  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Input Data Member</li>
      </ol>
    <!-- Contain -->
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <div class="panel-body">
                                   <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-member.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-8">
                                      <input name="no_hp" type="text" id="no_hp" class="form-control" placeholder="No. Hp" required />
                                  </div>
                              </div>
                              <div class="form-group">
